...
function userRouter(settings) {
    ...
    router.get('/profiel', ensureAuthenticatedUser, userEnsure2fa, (req, res) => {
    ...
    router.post('/upload', ensureAuthenticatedUser, userEnsure2fa, upload.single('profilePic'), (req, res) => {
        const userId = req.user.id;
    ...
    router.get('/view/:userId', ensureAuthenticatedUser, userEnsure2fa, (req, res) => {
    ...
    router.post('/delete/:userId', ensureAuthenticatedUser, userEnsure2fa, (req, res) => {
        const userId = req.params.userId;
    ...
    router.get('/setup-2fa', ensureAuthenticatedUser, (req, res) => {
    ...
    router.post('/verify-2fa', ensureAuthenticatedUser, (req, res) => {
        const token = req.body.token;
    ...
    router.post('/check-2fa', ensureAuthenticatedUser, (req, res) => {
        const token = req.body.token;
    ...
    router.post('/confirm-remove-2fa', ensureAuthenticatedUser, (req, res) => {
